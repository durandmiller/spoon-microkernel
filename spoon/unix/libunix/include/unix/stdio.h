...
typedef struct
{
	...
	unsigned long long pos;	///< The position in the file.

	int pushedBack;			///< To support	ungetc for 1 character
} FILE;
...
// Now we use trio for the printf and scanf functions
#include <nonstd/triodef.h>
#include <nonstd/trio.h>
